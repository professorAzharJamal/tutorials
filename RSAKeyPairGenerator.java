...
public class RSAKeyPairGenerator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String encryptedString = Base64.getEncoder().encodeToString(encrypt("Azhar Techo Coder", publicKey));
        System.out.println(encryptedString);
        String decryptedString = RSAKeyPairGenerator.decrypt(encryptedString, privateKey);
